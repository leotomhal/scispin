// demo_payload.js – clientseitige Kopie der 7-Stufen-Demo NUR für preview.html
window.SCISPIN_DEMO = {
 "-3": {
  ...
  "aenderungen": [
   {
    "typ": "veraendert",
    "original": "verbessern ihre Sprachkenntnisse",
    "neu": "L2-Kompetenzentwicklung",
    "fehlertyp": "Fachterminologie",
    "erklaerung": "Fachkürzel ('L2' für Zweitsprache) ersetzt eine allgemeinverständliche Formulierung."
   },
   {
    "typ": "veraendert",
    "original": "schnell in reguläre Schulklassen kommen",
    "neu": "frühzeitiger Regelklassenintegration",
    "fehlertyp": "Nominalstil",
    "erklaerung": "Verbalhandlung wird zur abstrakten Substantivkomposition verdichtet."
   },
   {
    "typ": "veraendert",
    "original": "Willkommensklassen",
    "neu": "segregative Vorbereitungsbeschulungsformate",
    "fehlertyp": "Bürokratische Komposita",
    "erklaerung": "Ein klarer Begriff wird durch eine mehrgliedrige Fachwortbildung ersetzt."
   },
   {
    "typ": "eingefuegt",
    "original": "",
    "neu": "signifikante Assoziation",
    "fehlertyp": "Statistikjargon",
    "erklaerung": "Methodensprache an prominenter Stelle, die Laien nicht entschlüsseln."
   }
  ]
 },
 "-2": {
  ...
  "aenderungen": [
   {
    "typ": "veraendert",
    "original": "verbessern ihre Sprachkenntnisse in Deutschland am ehesten",
    "neu": "günstigeren Sprachentwicklung assoziiert",
    "fehlertyp": "Akademischer Ton",
    "erklaerung": "Vorsichtige Fachsprache, korrekt, aber wenig zugänglich."
   },
   {
    "typ": "eingefuegt",
    "original": "",
    "neu": "institutioneller Beschulungsformen",
    "fehlertyp": "Fachbegriff",
    "erklaerung": "Abstrakte Kategorie statt konkreter Benennung."
   }
  ]
 },
 "-1": {
 ...
 "1": {
  ...
  "aenderungen": [
   {
    "typ": "veraendert",
    "original": "Junge Geflüchtete verbessern ihre Sprachkenntnisse in Deutschland am ehesten, wenn sie möglichst schnell in reguläre Schulklassen kommen.",
    "neu": "Wer als geflüchtetes Kind schnell in eine normale Schulklasse kommt, lernt besser Deutsch.",
    "fehlertyp": "Anschaulichkeit",
    "erklaerung": "Kernaussage nach vorn, konkrete Alltagssprache. Inhaltlich vollständig gedeckt."
   },
   {
    "typ": "eingefuegt",
    "original": "",
    "neu": "Überraschend:",
    "fehlertyp": "Aufhänger",
    "erklaerung": "Lenkt den Blick auf den eigentlichen Befund, ohne ihn zu übertreiben."
   }
  ]
 },
 "2": {
  ...
  "aenderungen": [
   {
    "typ": "veraendert",
    "original": "scheinen unzureichende Deutschkenntnisse nicht wie erhofft ausgleichen zu können",
    "neu": "bringen dabei kaum etwas",
    "fehlertyp": "Zuspitzung",
    "erklaerung": "Verschärft den vorsichtigen Befund, ohne ihn ins Falsche zu kippen – noch vertretbar."
   },
   {
    "typ": "eingefuegt",
    "original": "",
    "neu": "der Schlüssel",
    "fehlertyp": "Werbliche Überhöhung",
    "erklaerung": "Suggeriert Monokausalität; grenzwertig, weil die Studie nur einen starken Zusammenhang zeigt."
   },
   {
    "typ": "gestrichen",
    "original": "Die Arbeit wurde im Fachmagazin Acta Sociologica veröffentlicht.",
    "neu": "",
    "fehlertyp": "Gestrichener Beleg",
    "erklaerung": "Der Quellennachweis fällt weg – die Aussage wirkt dadurch freier, als sie ist."
   }
  ]
 },
 "3": {
  ...
  "aenderungen": [
   {
    "typ": "eingefuegt",
    "original": "",
    "neu": "Bildungs-Sensation",
    "fehlertyp": "Sensationsframing",
    "erklaerung": "Dramatisierung ohne Grundlage in den Daten."
   },
   {
    "typ": "veraendert",
    "original": "Das zeigt eine neue Studie",
    "neu": "Studie beweist",
    "fehlertyp": "Überzogene Kausalität",
    "erklaerung": "'Beweist' überschreitet, was eine Beobachtungsstudie leisten kann."
   },
   {
    "typ": "veraendert",
    "original": "nicht wie erhofft ausgleichen zu können",
    "neu": "schaden",
    "fehlertyp": "Claim über die Forschung hinaus",
    "erklaerung": "'Schaden' behauptet einen negativen Effekt, den die Studie nicht zeigt."
   },
   {
    "typ": "eingefuegt",
    "original": "",
    "neu": "Experten fordern die sofortige Abschaffung",
    "fehlertyp": "Untergeschobene Forderung",
    "erklaerung": "Politische Forderung, die nicht Teil der Meldung ist."
   },
   {
    "typ": "gestrichen",
    "original": "für die sie Daten von mehr als 1.000 Jugendlichen auswerteten",
    "neu": "",
    "fehlertyp": "Gestrichene Methode",
    "erklaerung": "Der Hinweis auf die Datengrundlage fällt weg – gerade er macht die Aussage einordbar."
   }
  ]
 }
};
