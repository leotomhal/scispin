...
<style>
  ...
  h1 { font-size:1.4rem; }
  .todo { background:#fff8e1; border:1px solid #ffe082; border-radius:8px; padding:1rem; }
</style>
</head>
<body>
<main>
  ...
  <div class="todo">
    <strong>Platzhalter.</strong> Vor Veröffentlichung mit einem rechtlich geprüften Text
    füllen. Hinweis: Diese Anwendung speichert IP-Adressen nur anonymisiert (täglich
    rotierender Hash) fürs Rate-Limit; Studien-Links und Analyseergebnisse werden zwischengespeichert.
